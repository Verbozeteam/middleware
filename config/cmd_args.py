...
if not hasattr(sys, '_called_from_test'):
    ...
    parser.add_argument("-h", "--host", required=False, nargs='+', help="List of network interfaces to host sockets on")
    ...
    if cmd_args.host: CONTROLLERS_CONFIG.SOCKET_HOSTING_INTERCACES = list(cmd_args.host)
